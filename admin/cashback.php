...
<p><button class="btn btn-primary 1">Membeli Voucher Nawar Rp.1</button> <button class="btn btn-danger 2">Membeli Produk Lelang</button></p></center>
<br>
<div class="div1" style="display:none">
<center><h4>Biaya Yang Harus Di Keluarkan</h4></center>
...
<div class="row">
	...
	<input type="text" name="uks" onkeyup="formatangka(this)" required>X200</b>
	</div>
	<div class="col-sm-4">
	<b>Ukuran Yang Di Inginkan
	<input type="text" name="uki" onkeyup="formatangka(this)" required>X200</b>
	</div>
	<div class="col-sm-2">
	</div>
</div>
<div class="row" style="margin-top:20px">
	...
	<input type="text" name="hn" onkeyup="formatangka(this)" required></b>
	</div>
	<div class="col-sm-2">
...
<div class="row" id="ukuran" style="margin-top:20px">
 <div class="row col-sm-12">
	...
	<input type="text" name="ukp" placeholder="180" onkeyup="formatangka(this)">X200</b>
	</div>
	<div class="col-sm-4">
	<b><span style="color:red">Ukuran Kemenangan</span>
	<input type="text" name="ukk" placeholder="160" onkeyup="formatangka(this)">X200</b>
	</div>
	<div class="col-sm-2">
	</div>
 </div>
 <div class="row col-sm-12" style="margin-top:20px">
	...
	<div class="col-sm-4">
	<b><span style="color:blue">Harga Netto Ukuran Pembelian</span>
...
if(isset($_POST)){
	...
	if($uks < $uki){
		...
		$biaya=$hnn-($hnn*0.075);
		$harga=$hkk + $biaya;
		echo "<center class='div3'><h3>Harga Kemenangan : ".$hk." Biaya Upgrade : ".number_format($biaya,0,',','.')."</h3></center><br>";
		echo "<h2 class='div3'><center>Total Biaya Rp. " .number_format($harga,0,',','.')."</center></h2>";
		}else{
		echo "<h4 style='color:red' class='div3'><center>Terjadi Kesalahan Pada Ukuran</center></h4>";
		}
		...
		echo "<h2 class='div3'><center>Total Cashback Yang Di Terima Rp. " .number_format($cashback,0,',','.')."</center></h2>";

...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT *";
	$sql.=" FROM inven";
	$sql.=" WHERE jenis LIKE '%".$requestData['search']['value']."%'";    // $requestData['search']['value'] contains search parameter
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<a href='inven_edit?edit=".$row['jenis'] .'/'.$row['type']."' class='btn btn-primary brand'>Edit</a>";
	$data[] = $nestedData;

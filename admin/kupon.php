<html> <head> <?php include "menu.php"; include "../koneksiremote.php"; ?> <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
  <link rel="stylesheet" href="../css/tablejquery.css"> <script src="../asset/tablejquery.js"></script>
 <body>
 <div class='container'>
 <a href="#add1" style='float:left' data-toggle="modal" class="btn btn-primary brand">INPUT KUPON FLASHSALE</a>
 <center><a id='show' class='btn btn-danger btn-lg'>LIST UPDATE KUPON FLASHSALE</a></center>
 </div>
 
	<div id="add1" class="modal fade" role="dialog"> <div class="modal-dialog modal-lg"> <form action="kupon_proses" method="POST">
   <div class="modal-content">
    	<div class="modal-header">
		 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title" id="myModalLabel"><center><b>FORM KUPON CK</b></center></h4>
        </div>

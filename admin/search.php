...
echo "<div class='container'>
 ...
 <center><ul class="pagination">
        ...
        ?>
          <li><a href="search.php?page=1&cari=<?php echo $cari ?>&search=<?php echo $search ?>&asal=<?php echo $asal ?>">First</a></li>
          <li><a href="search.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
        <?php
        }
        ?>
       ...
       // $sql2->execute(); // Eksekusi querynya
        ...
        ?>
          <li<?php echo $link_active; ?>><a href="search.php?page=<?php echo $i; ?>&cari=<?php echo $cari ?>&search=<?php echo $search ?>&asal=<?php echo $asal ?>"><?php echo $i; ?></a></li>
        <?php
        }
        ?>
        ...
        ?>
          <li><a href="search.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
          <li><a href="search.php?page=<?php echo $jumlah_page; ?>&cari=<?php echo $cari ?>&search=<?php echo $search ?>&asal=<?php echo $asal ?>">Last</a></li>
        <?php
        }
        ?>
      </ul></center>

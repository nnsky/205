...
if($_POST['perihal']==null){
	...
	$conn->query("insert into dbkonsumen (nama,nik,hp,email,alamat,kdpkt,seri,notam,notas,notaq,tanggalm,tanggals,tanggalq,user,tanggal,cabang) VALUE('$nama','$nik','$hp','$email','$alamat','$kdpkt','$seri','$matt','$sofa','$qual','$tglmatt','$tglsofa','$tglqual','$user','$tglambil','$lokasi')");

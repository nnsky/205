...
if($lokasi=='gck'){
	$conn->query("insert into inven_stock (jenis,type,lokasi,store,stock,terpakai,rusak,catatan,kode_produk,user) values ('$jenis','$type','LT 7','$lokasi',0,0,0,'','$kode_produk','$user')");
	$conn->query("insert into inven_stock (jenis,type,lokasi,store,stock,terpakai,rusak,catatan,kode_produk,user) values ('$jenis','$type','LT 8','$lokasi',0,0,0,'','$kode_produk','$user')");
	$conn->query("insert into inven_stock (jenis,type,lokasi,store,stock,terpakai,rusak,catatan,kode_produk,user) values ('$jenis','$type','LT 9','$lokasi',0,0,0,'','$kode_produk','$user')");
	$conn->query("insert into inven_stock (jenis,type,lokasi,store,stock,terpakai,rusak,catatan,kode_produk,user) values ('$jenis','$type','LT 10','$lokasi',0,0,0,'','$kode_produk','$user')");
	$conn->query("insert into inven_stock (jenis,type,lokasi,store,stock,terpakai,rusak,catatan,kode_produk,user) values ('$jenis','$type','LT 11','$lokasi',0,0,0,'','$kode_produk','$user')");
}else{

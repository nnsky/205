...
$sql = "SELECT *";
$sql.=" FROM voucherck where lokasi ='".$_SESSION['lokasi']."' && seri like '%2020%'";
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT *";
	$sql.=" FROM voucherck";
	$sql.=" WHERE (voucher LIKE '%".$requestData['search']['value']."%' && lokasi ='".$_SESSION['lokasi']."')";    // $requestData['search']['value'] contains search parameter
	...
	$sql.=" OR (total LIKE '%".$requestData['search']['value']."%' && lokasi ='".$_SESSION['lokasi']."')";
	...
	$sql = "SELECT *";
	$sql.=" FROM voucherck where lokasi ='".$_SESSION['lokasi']."' && seri like '%2021%'";
   ...
   <div class="modal-content">
    	...
    	<div class="modal-header">
		 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h4 class="modal-title" id="myModalLabel"><center><b>No Seri  '.$row["seri"].'</b></center></h4>
        </div>

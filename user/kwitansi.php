...
}elseif($_SESSION['level']=="user" && $_SESSION['status']=='aktif' && $array['kw_v']=='block'){
...
<div class="container" style='margin-top:-30px;'>		
	<br/>
	<button class="btn btn-primary buat" data-toggle="modal" data-target="#ModalAdd">Buat</button>
</div>
...
<div class="modal-dialog modal-lg">
	...
	<form role="form" method="POST" action="cekkwitansi.php" >
...
<option value="CM">Pramuka CM</option>
<option value="CH">Pramuka CH</option>
<option value="CPG">Premium Gallery</option>
<option value="CPIK">Pik</option>
<option value="ALS">Ruko ALSut</option>
<option value="KGN">Kelapa Gading</option>
...
<td><button type="reset" class="btn btn-danger"  data-dismiss="modal" aria-hidden="true">Cancel</button>
</td>
</tr>
		</table>
    </form>

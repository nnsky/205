...
}elseif($_SESSION['level']=="user"  && $_SESSION['status']=='aktif' && $array['lelang_v']=='block'){
...
<div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><center><b>Pendaftaran Bazaar Chandra Karya</b></center></h4>
        </div>

		 ...
		 <center><h4>Data Konsumen</h4></center>
          <div class="form-group">
		   ...
		   <label for="recipient-name" class="col-form-label">Gelar</label>
			...
			<div class="col-sm-4">
            <label for="recipient-name" class="col-form-label">Tanggal Pengambilan Voucher</label>
            <input type="text" id="datetimepicker3" class="form-control" name="tglambil" required autocomplete='off'>
			</div>
          </div>		  
		  <div class="form-group">
			<div class="col-sm-4">
            ...
            <select id="kupon1" class="form-control" style="display:none;" name='kp1'>
						<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select kdpkt from dbkupon where paket='P1' && lokasi='$lokasi' && status='aktif' order by kdpkt asc";
			...
			<select id="kupon2" class="form-control" style="display:none;" name='kp2'>
					<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select kdpkt from dbkupon where paket='P2' && lokasi='$lokasi' && status='aktif' order by kdpkt asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['kdpkt']."'>".$qarray['kdpkt']."</option>";
			...
			<select id="kupon3" class="form-control" style="display:none;" name='kp3'>
					<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select kdpkt from dbkupon where paket='P3' && lokasi='$lokasi' && status='aktif' order by kdpkt asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['kdpkt']."'>".$qarray['kdpkt']."</option>";
			...
			<select id="kupon4" class="form-control" style="display:none;" name='kp4'>
					<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select kdpkt from dbkupon where paket='P4' && lokasi='$lokasi' && status='aktif' order by kdpkt asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['kdpkt']."'>".$qarray['kdpkt']."</option>";
					...
					<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select kdpkt from dbkupon where paket='P5' && lokasi='$lokasi' && status='aktif' order by kdpkt asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['kdpkt']."'>".$qarray['kdpkt']."</option>";
					...
					<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select kdpkt from dbkupon where paket='P6' && lokasi='$lokasi' && status='aktif'";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['kdpkt']."'>".$qarray['kdpkt']."</option>";
		 	...
		 	<div class="form-group">
				...
				<label for="recipient-name" class="col-form-label">Seri Voucher</label>
					<select id="paket1" class="form-control" style="display:none;" name='p1'>
						...
						<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select seri from dbvoucher where paket='P1' && lokasi='$lokasi' && status='aktif' order by seri asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
					...
					<select id="paket2" class="form-control" style="display:none;" name='p2'>
						...
						<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select seri from dbvoucher where paket='p2' && lokasi='$lokasi'  && status='aktif' order by seri asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['seri']."'>".$qarray['seri']."</option>";
					...
					<select id="paket3" class="form-control" style="display:none;" name='p3'>
						...
						<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select seri from dbvoucher where paket='p3' && lokasi='$lokasi'  && status='aktif'  order by seri asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['seri']."'>".$qarray['seri']."</option>";
					...
					<select id="paket4" class="form-control" style="display:none;" name='p4'>
						...
						<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select seri from dbvoucher where paket='p4' && lokasi='$lokasi'  && status='aktif' order by seri asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['seri']."'>".$qarray['seri']."</option>";
					...
					<select id="paket5" class="form-control" style="display:none;" name='p5'>
						...
						<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select seri from dbvoucher where paket='p5' && lokasi='$lokasi'  && status='aktif' order by seri asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['seri']."'>".$qarray['seri']."</option>";
					...
					<select id="paket6" class="form-control" style="display:none;" name='p6'>
						...
						<?php
							$lokasi=$_SESSION['lokasi'];
							$select="select seri from dbvoucher where paket='p6' && lokasi='$lokasi'  && status='aktif' order by seri asc";
							$qselect=mysqli_query($conn,$select);
							while($qarray=mysqli_fetch_array($qselect)){
						echo "<option value='".$qarray['seri']."'>".$qarray['seri']."</option>";

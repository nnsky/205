...
<p><h4>In Store</h4></p>
<?php
	$select="select *from respon where (status='pending' or status='Proses') && responid like '%$lokasi%' order by status ASC,no DESC";
	...
	while($array=mysqli_fetch_array($query)){
		...
		echo "
			<div class='col-sm-12' style='border:1px solid;background-color:".$warna.";'>
				...
				<br>
				<h4><div class='col-sm-6'>Nama : ".$array['nama']."</div> <div class='col-sm-6'>Kontak : ".$array['kontak']."</div> <br>
				<div class='col-sm-6'>Tanggal : ".$array['tanggal']."</div> <div class='col-sm-6'>Nota : ".$array['nota']."</div><br>
				<div class='col-sm-6'>Sales : ".$array['untuk']."</div> <div class='col-sm-6'>Batas Pengerjaan : ".$array['hari']."</div><br>
				</h4>
...
<?php
	$aselect="select *from asales where (status='Pending' or status='Proses') && lokasi='$lokasi' order by status ASC";
	...
	while($as=mysqli_fetch_array($aquery)){
		...
		echo "
			<div class='col-sm-12' style='border:1px solid'>
				<center><h4><a class='btn btn-".$coloras."' href='tasrespon?&_id=".$as['ticketid']."&user=".$_SESSION["username"]."'>Tiket Respon : ".$as['ticketid']."</a></h4></center>
				<br>
				<h4><div class='col-sm-6'>Nama : ".$as['nama']."</div> <div class='col-sm-6'>Kontak : ".$as['kontak']."</div> 
				<div class='col-sm-6'>Tanggal : ".$as['tglkirim']."</div> <div class='col-sm-6'>Nota : ".$as['nota']."</div>
				<div class='col-sm-6'>Sales : ".$as['sales']."</div> <div class='col-sm-6'>Batas Pengerjaan : ".$as['hari']."</div>
				</h4>
				<div style='clear:both'></div><br>

...
<form action="cekedit" method="post">
	...
	<div class="form-group ">
				...
				<div class="col-sm-12">
				<label for="recipient-name" class="col-form-label">Total Diskon Yang Diberikan</label>
				<input type="text" class="form-control" name="diskon" onkeyup="formatangka(this)" value="<?php echo $array['diskon']?>" placeholder="Diskon (%)">
				</div>
				<br>
